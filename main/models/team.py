...
class Team(models.Model):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "age": self.mean_age,
            "tenure": self.mean_tenure,
            "overconfidence": self.mean_overconfidence_score,
            "history": self.mean_team_history,
            "voice_behavior": self.mean_voice_behavior,
            "coordination": self.mean_team_coordination,
            "effectiveness": self.mean_team_effectiveness,
        }
